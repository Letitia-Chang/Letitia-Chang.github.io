    ...
    <section id="top">
      <div className="mx-auto max-w-6xl px-6 pb-16 pt-10 md:pb-24 md:pt-14">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-[auto_auto]">
          <div className="flex flex-col justify-between rounded-3xl bg-panel/60 p-8 md:col-span-2 md:p-10">
            <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <a
                href="#projects"
                className="rounded-full bg-tan-soft px-6 py-3 text-sm font-medium text-ink transition-colors hover:bg-tan"
              >
                View projects
              </a>
              <a
                ...
                rel="noreferrer"
                aria-label="GitHub"
                className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-tan-soft transition-colors hover:bg-ink"
              >
              ...
              <a
                ...
                rel="noreferrer"
                aria-label="LinkedIn"
                className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-tan-soft transition-colors hover:bg-[#0A66C2]"
              >
